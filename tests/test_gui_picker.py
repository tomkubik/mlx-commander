...
from mlx_commander.gui_picker import (
    is_macos,
    pick_dataset_gui,
    pick_file_gui,
    pick_folder_gui,
...
class TestGUIPicker(unittest.TestCase):
    ...
    @patch("mlx_commander.gui_picker._compile_picker_at_runtime")
    def test_runtime_picker_selection(self, mock_bin, mock_run):
        mock_bin.return_value = "/tmp/mlx_commander_picker_test"
    ...
    @patch("mlx_commander.gui_picker.run_runtime_compiled_picker")
    def test_pick_dataset_gui_success(self, mock_picker):
        mock_picker.return_value = "/Users/tomkubik/dataset"
        with patch("mlx_commander.gui_picker.is_macos", return_value=True):
