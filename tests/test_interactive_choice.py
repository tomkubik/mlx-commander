...
from mlx_commander.tui.wizard_fallback import (
...
class TestInteractiveChoice(unittest.TestCase):
    ...
    @patch("mlx_commander.tui.wizard_fallback.sys.stdout.write")
    @patch("mlx_commander.tui.wizard_fallback.sys.stdout.flush")
    @patch("mlx_commander.tui.wizard_fallback.tty.setcbreak")
    @patch("mlx_commander.tui.wizard_fallback.termios.tcgetattr")
    @patch("mlx_commander.tui.wizard_fallback.termios.tcsetattr")
    @patch("mlx_commander.tui.wizard_fallback.sys.stdin.fileno", return_value=0)
    def test_arrow_down_and_enter(self, mock_fn, mock_tcset, mock_tcget, mock_cbreak, mock_flush, mock_write):
        with patch("mlx_commander.tui.wizard_fallback._read_char", side_effect=["DOWN", "ENTER"]):
    ...
    def test_arrow_up_wrap_and_enter(self, mock_fn, mock_tcset, mock_tcget, mock_cbreak, mock_flush, mock_write):
        with patch("mlx_commander.tui.wizard_fallback._read_char", side_effect=["UP", "ENTER"]):
    ...
    def test_number_jump_and_enter(self, mock_fn, mock_tcset, mock_tcget, mock_cbreak, mock_flush, mock_write):
        with patch("mlx_commander.tui.wizard_fallback._read_char", side_effect=["3", "ENTER"]):
    ...
    def test_multi_digit_number(self, mock_fn, mock_tcset, mock_tcget, mock_cbreak, mock_flush, mock_write):
        ...
        with patch("mlx_commander.tui.wizard_fallback._read_char", side_effect=["1", "2", "ENTER"]):
    ...
    def test_number_then_arrow_mix(self, mock_fn, mock_tcset, mock_tcget, mock_cbreak, mock_flush, mock_write):
        with patch("mlx_commander.tui.wizard_fallback._read_char", side_effect=["2", "DOWN", "ENTER"]):
    ...
    def test_ctrl_c_raises_keyboard_interrupt(self, mock_fn, mock_tcset, mock_tcget, mock_cbreak, mock_flush, mock_write):
        with patch("mlx_commander.tui.wizard_fallback._read_char", side_effect=KeyboardInterrupt):
    ...
    def test_non_tty_fallback(self):
        with patch("mlx_commander.tui.wizard_fallback.sys.stdin.isatty", return_value=False):
            with patch("mlx_commander.tui.wizard_fallback.ask_input", return_value="2"):
